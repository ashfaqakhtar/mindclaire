        ...
        <div class="col-md-8">
            <div class="blog-details-box">
                ...
                <div class="detail-blog-head">
                    <h1>Psychotropics Are Tools, Not Villains: Dr. Ritu Goel's comment in JAMA Pediatrics.</h1>
                    <p>by Dr. Ritu Goel | September 08, 2025 | Press Releases | 0 comments</p>
                </div>
                ...
                <div class="blog-detail-body">
                    <p>Dr. Ritu Goel responds to a controversial federal report in her published comment in JAMA
                        Pediatrics, emphasizing that psychotropic medications when used responsibly are tools, not
                        threats.
                    </p>
                    <br>

                    <p>She advocates for balanced, evidence-based care that includes therapy, family support, and
                        lifestyle interventions alongside medication. A reminder that thoughtful, integrative care is
                        what truly helps children heal.</p>
                    <br>

                    <a target="_blank" class=""
                        href="https://jamanetwork.com/journals/jamapediatrics/article-abstract/2838296">
                        Read More
                    </a>
        ...
        <div class="col-md-3">
            <div class="blog-right">
                ...
                <div class="recent-link-box">
                    <a href="depression-and-herbs">Depression & Herbs: What St. John’s Wort can do – Dr. Ritu Goel explains.</a>
                    <br>
                    <br>
