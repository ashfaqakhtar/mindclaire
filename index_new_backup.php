...
?>
<section class="background-cover slick_1">
    <div class="slide slide--1">
        <div class="container-fluid header_bg mobile_display_none">
            <div class="container">
                <div class="row home-banner-box">
                    <div class="col-md-6">
                        ...
                        <a href="#"><img class="img-fluid" src="assets/img/banner_cta.png"></a>
    ...
    <div class="slide slide--2">
        <div class="container-fluid header_bg_2 mobile_display_none" style="height: 100vh;">
            <div class="container" style="height: 100vh;">
                <div class="row home-banner-box">
                    <div class="col-md-6">
                        <div class="home-banner-first">
                            <h2 class="">Mindclaire AI Wellness </br> Plan for SMEs </h2>
                        </div>
                        <a href="#"><img class="img-fluid" src="assets/img/banner_cta.png"></a>
                        <h5 class="home_page_sub">Revolutionizing employee wellness with AI-driven insights and
                            personalized
                            care. Enhance well-being, productivity, and job satisfaction. </h5>
                    </div>
                    <div class="col-md-6">
                        <img src="assets/img/Frame.png" class="img-fluid" style="padding: 142px 47px;">
                    </div>
                </div>
            </div>
        </div>
...
<section class="container-fluid header_bg_mobile  mobile_display_block">
    <div class="container">
        <div class="row home-banner-box">
            <div class="col-md-6">
                <div class="home-banner-first">
            ...
            <div class="col-md-6">
                <img class="img-fluid" src="assets/img/banner_cta.png">
                <h5 class="home_page_sub">Welcome to MindClaire, where I assist you towards harmony among mind, body,
    ...
    <div class="row">
        <div class="col-md-5">
            <div class="ritu-image mobile_display_none">
                <img src="./assets/img/ritu-1.jpg" alt="ritu_pic">
            </div>
                    ...
                    <div class="col-md-6">
                        <div class="second-ai-box">
                            <p>Our AI Wellness Plan integrates mental health, physical health, preventive care, and
                                ...
                                needs
                                of SMEs, ensuring that your team is supported holistically.</p>
                            <a class="dark-cta-box" href="#">Discover the Benefits</a>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="second-ai-box">
                            <img src="./assets/img/ai-image.webp" alt="AI Image" class="img-fluid" height="300px">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="">
                            <img src="https://mindclaire.com/assets/img/ai-image-2.webp" class="img-fluid"
                                alt="AI Image" height="400px">
                        </div>
                    </div>
                </div>
            </div>
