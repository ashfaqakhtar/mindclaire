...
?>
<section class="main_slider"  style="height: 100vh;">
        ...
        <div class="container"  style="height: 100vh;">
            <div class="row home-banner-box">
                <div class="col-md-6">
                    ...
                    <a href="#"><img class="img-fluid" src="assets/img/banner_cta.png"></a>
                    <h5 class="home_page_sub">Revolutionizing employee wellness with AI-driven insights and personalized care. Enhance well-being, productivity, and job satisfaction. </h5>
                </div>
                <div class="col-md-6">
...
<div class="container-fluid">
    <div class="wellness-ai-banner">
        <div class="container slider-box-space">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="second-ai-box">
                        <p>Our AI Wellness Plan integrates mental health, physical health, preventive care, and
                            financial wellness into a seamless experience. It's designed specifically to meet the needs
                ...
                <div class="col-md-6">
                    <div class="second-ai-box">
                        <img src="./assets/img/ai-image.webp" alt="AI Image" height="300px">
                    </div>
                </div>
            </div>
        </div>
        <div class="container slider-box-space">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="">
                        <img src="https://mindclaire.com/assets/img/ai-image-2.webp" alt="AI Image" height="400px">
                    </div>
                </div>
            </div>
        </div>
