        ...
        <div class="col-md-12">
            <div class="home-sticker">
                <div class="home-sticker-box">
                    <img src="./assets/img/Cambridge_1.webp"
                        alt="camb-sticker">
                </div>
                <div class="home-sticker-box">
                    <img src="./assets/img/Advance_1.webp"
                        alt="advanc-sticker">
                </div>
                <div class="home-sticker-box">
                    <img src="./assets/img/Current_1.webp"
                        alt="currnt-stikcer">
                </div>
                <div class="home-sticker-box">
                    <img src="./assets/img/Psycology-today_1.webp"
                        alt="psy-sticker">
                </div>
                <div class="home-sticker-box">
                    <img src="./assets/img/Honored-Listee_1.webp"
                        alt="current">
                </div>
                <div class="home-sticker-box">
