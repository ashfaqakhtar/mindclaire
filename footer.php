        ...
        <div class="container-fluid">
            <div class="row d-flex justify-content-end">
                ...
                <div class="col-md-9 right-footer">
                        ...
                        <div class="right-top-footer">
                            ...
                            <div class="inner-footer col">
                                ...
                                <div class="footer-icons">
                                    ...
                                    <a href="https://www.linkedin.com/company/mindclaire/" target="_blank"><i class="fa-brands fa-linkedin"></i></a>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md right-bottom-footer">
                            <hr>
	...
	<script>
		$(window).scroll(function() {
            if ($(document).scrollTop() > 50) {
                ...
                $(".logo-icon").attr("src",
                    "https://www.occamsadvisory.com/wp-content/uploads/2023/09/dr.ritu-mindcleair-logo.svg");
